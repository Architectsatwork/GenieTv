...
GVI2 = "http://architects.x10host.com/vids/intro.wmv"
...
def TEXTS():
    addDir('[COLORgreen]SOURCE LIST[/COLOR]',BASEURL,46,ART+'TUTS.png',FANART,'')
    addDir('[COLORgreen]TEST[/COLOR]',BASEURL,47,ART+'TUTS.png',FANART,'')
    setView('movies', 'MAIN')

def SOURCES():
    TextBoxes('These are the main Sources you should get into you XBMC', '[COLORwhite]http://architects.x10host.com[/COLOR]--- [COLORred]http://repo.sharktech.co.uk[/COLOR]---  [COLORwhite]http://fusion.tvaddons.ag[/COLOR]--- [COLORred]http://i.totalxbmc.tv[/COLOR]---  [COLORwhite]http://www.xunitytalk.com/xfinity[/COLOR]--- [COLORred]http://srp.nu[/COLOR]---  [COLORwhite]http://solved.no-issue.ca[/COLOR]--- [COLORred]http://xbmc.aminhacasadigital.com[/COLOR]---  [COLORwhite]http://xbmc.movieshd.co[/COLOR]--- [COLORred]http://install.kaosbox.tv[/COLOR]---  [COLORwhite]http://kodi-repo.com/mxr[/COLOR]--- [COLORred]http://kodi.metalkettle.co[/COLOR]---  [COLORwhite]http://prozone.getxbmc.com[/COLOR]--- [COLORred]http://transform.mega-tron.tv[/COLOR]---  [COLORwhite]http://muckys.kodimediaportal.ml[/COLOR]--- [COLORred]http://jas0npc.pcriot.com[/COLOR]--- [COLORwhite]Sports devil source[/COLOR]--- [COLORred]http://iwillfolo.com/iwf[/COLOR]')

def GEVID():            
    if ADDON.getSetting('vid') == "true":
        xbmcPlayer=xbmc.Player()
        xbmcPlayer.play(GVI2)
        xbmc.sleep(250)
